...
<body>
    ...
    <main>
        <div class="imgcontainer">
            <div class="main-image img_banner">
                <img class="img_banner" id="displayed-image" src="https://cdn.honda.com.vn/motorbikes/December2021/ELAzjUmkQRG0SyOYxUU0.jpg">
            </div>
        </div>
    ...
    @endif
                ...
                <div class="product-info">
                    ...
                    <a href="/banggia-sanpham" class="price-button">BẢNG GIÁ SẢN PHẨM ➜</a>
                </div>
            </div>
        </div>
        <section id="content" class="content">
            <div class="container">
                <div class="row">
                @foreach ($xeMays as $xe)
                    <div class="col-md-4 mb-5">
  


                        
                        <a href="/chitiet-sanpham?id_xe={{$xe->id_xe}}">
                            
                        <div class="car-card">
                            <img src="{{$xe->hinh_anh}}" alt="Xe hơi" class="car-image">
                            <div class="car-info">
                                <h2 class="car-name">{{$xe->ten_xe}}</h2>
                                <p class="car-price">Giá: {{$xe->gia}} VND</p>
                            </div>
                        </div>
                        </a>
